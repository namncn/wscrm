...
class AppsApi
{
    ...
    public function deleteWebsiteAppRequest($org_id, $website_id, $app_id, $backup_before_operation = null)
    {
        ...
        // query params
        if ($backup_before_operation !== null) {
            if('form' === 'form' && is_array($backup_before_operation)) {
                foreach($backup_before_operation as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['backupBeforeOperation'] = $backup_before_operation;
            }
        }
