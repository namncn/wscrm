...
class SettingsApi
{
     ...
     * @return void
     */
    public function updateSetting($name, $unknown_base_type)
    {
        $this->updateSettingWithHttpInfo($name, $unknown_base_type);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSettingWithHttpInfo($name, $unknown_base_type)
    {
        $request = $this->updateSettingRequest($name, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSettingAsync($name, $unknown_base_type)
    {
        return $this->updateSettingAsyncWithHttpInfo($name, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSettingAsyncWithHttpInfo($name, $unknown_base_type)
    {
        $returnType = '';
        $request = $this->updateSettingRequest($name, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSettingRequest($name, $unknown_base_type)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling updateSetting'
            );
        }
