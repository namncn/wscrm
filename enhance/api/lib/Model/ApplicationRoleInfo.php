...
/**
 * ApplicationRoleInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationRoleInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationRoleInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['filerd'] = $data['filerd'] ?? null;
        $this->container['screenshotd'] = $data['screenshotd'] ?? null;
        $this->container['ftpcd'] = $data['ftpcd'] ?? null;
     ...
     * Sets websites_count
     *
     * @param int $websites_count The number of websites that are assigned to be on this application role.
     *
     * @return self
     */
