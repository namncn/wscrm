...
class CanonicalRedirect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['use_www'] = $data['use_www'] ?? null;
        $this->container['use_https'] = $data['use_https'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_www'] === null) {
            $invalidProperties[] = "'use_www' can't be null";
        }
    ...
    {
        $this->container['use_www'] = $use_www;
