...
class EmailRoleInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mailbox_count'] = $data['mailbox_count'] ?? null;
        $this->container['failed_delivery_count'] = $data['failed_delivery_count'] ?? null;
        $this->container['mtacd'] = $data['mtacd'] ?? null;
        $this->container['imapcd'] = $data['imapcd'] ?? null;
        $this->container['spamcd'] = $data['spamcd'] ?? null;
