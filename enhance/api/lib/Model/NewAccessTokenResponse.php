...
class NewAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['first_five'] = $data['first_five'] ?? null;
        $this->container['unencrypted_token'] = $data['unencrypted_token'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['first_five'] === null) {
            $invalidProperties[] = "'first_five' can't be null";
        }
    ...
    {
        return $this->container['first_five'];
    }
    ...
    {
        $this->container['first_five'] = $first_five;

        return $this;
    }

    /**
     * Gets unencrypted_token
     *
     * @return string
     */
    public function getUnencryptedToken()
    {
        return $this->container['unencrypted_token'];
    }
    ...
    {
        $this->container['unencrypted_token'] = $unencrypted_token;
