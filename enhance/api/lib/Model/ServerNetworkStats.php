...
/**
 * ServerNetworkStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerNetworkStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerNetworkStats';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['packet_loss'] = $data['packet_loss'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['packet_loss'] === null) {
            $invalidProperties[] = "'packet_loss' can't be null";
        }
     ...
     * Sets latency
     *
     * @param float $latency Latency to the server in milliseconds.
     *
     * @return self
     */
     ...
     * Sets packet_loss
     *
     * @param float $packet_loss Packet loss percentage
     *
     * @return self
     */
