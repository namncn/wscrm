...
/**
 * ServiceSslCertWithData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceSslCertWithData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceSslCertWithData';
    ...
    protected static $openAPITypes = [
        ...
        'alt_names' => 'string[]',
        'kind' => 'string',
        'mappings' => '\OpenAPI\Client\Model\ServiceSslCertMapping[]',
        'cert' => 'string',
        'pkey' => 'string',
        'fullchain' => 'string'
    ];
    ...
    const KIND_SELFSIGNED = 'selfsigned';
    const KIND_LETSENCRYPT = 'letsencrypt';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alt_names'] = $data['alt_names'] ?? null;
        $this->container['kind'] = $data['kind'] ?? null;
        $this->container['mappings'] = $data['mappings'] ?? null;
        $this->container['cert'] = $data['cert'] ?? null;
        $this->container['pkey'] = $data['pkey'] ?? null;
        $this->container['fullchain'] = $data['fullchain'] ?? null;
    }
     ...
     * Gets mappings
     *
     * @return \OpenAPI\Client\Model\ServiceSslCertMapping[]|null
     */
     ...
     * Sets mappings
     *
     * @param \OpenAPI\Client\Model\ServiceSslCertMapping[]|null $mappings mappings
     *
     * @return self
     */
