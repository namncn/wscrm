...
class SetCgroupLimits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['nproc'] = $data['nproc'] ?? null;
        $this->container['memory_limit'] = $data['memory_limit'] ?? null;
        $this->container['iops'] = $data['iops'] ?? null;
        $this->container['io_bandwidth'] = $data['io_bandwidth'] ?? null;
        $this->container['virtual_cpus'] = $data['virtual_cpus'] ?? null;
    }
