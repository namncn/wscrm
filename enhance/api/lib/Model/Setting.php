...
class Setting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'value' => 'OneOfStringNumberBooleanArrayObject'
    ];
     ...
     * Gets value
     *
     * @return OneOfStringNumberBooleanArrayObject
     */
     ...
     * Sets value
     *
     * @param OneOfStringNumberBooleanArrayObject $value An arbitrary JSON serializable value.
     *
     * @return self
     */
