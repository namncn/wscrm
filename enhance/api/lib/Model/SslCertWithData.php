...
/**
 * SslCertWithData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SslCertWithData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SslCertWithData';
    ...
    protected static $openAPITypes = [
        ...
        'alt_names' => 'string[]',
        'kind' => 'string',
        'mappings' => '\OpenAPI\Client\Model\SslCertMapping[]',
        'cert' => 'string',
        'pkey' => 'string',
        'fullchain' => 'string'
    ];
     ...
     * Gets mappings
     *
     * @return \OpenAPI\Client\Model\SslCertMapping[]|null
     */
     ...
     * Sets mappings
     *
     * @param \OpenAPI\Client\Model\SslCertMapping[]|null $mappings mappings
     *
     * @return self
     */
