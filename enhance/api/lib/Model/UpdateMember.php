...
/**
 * UpdateMember Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMember implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['site_accesses'] = $data['site_accesses'] ?? null;
     ...
     * Sets roles
     *
     * @param \OpenAPI\Client\Model\Role[]|null $roles roles
     *
     * @return self
     */
     ...
     * Sets site_accesses
     *
     * @param string[]|null $site_accesses This field is only present if member has \"SiteAccess\" role. In this case, the list contains the ids of the websites to which member has access.
     *
     * @return self
     */
