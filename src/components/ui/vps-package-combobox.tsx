...
interface VpsPackageComboboxProps {
  packages: VpsPackage[]
...
export function VpsPackageCombobox({
  packages,
  value,
  onValueChange,
        ...
        >
          {selectedPackage ? (
            <span className="truncate">
              {selectedPackage.planName} ({selectedPackage.cpu}CPU / {selectedPackage.ram}GB RAM)
            </span>
          ) : (
              ...
              >
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {pkg.cpu} CPU / {pkg.ram}GB RAM / {pkg.storage}GB Storage
                  </span>
                </div>
              </div>
            ))
